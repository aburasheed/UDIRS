...
namespace UDIRS.Web.Admin
{
    public partial class InvestigationHistory : System.Web.UI.Page
    {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (ahref != null)
                    if (DataBinder.Eval(e.Row.DataItem, "Id") != null)
                        ahref.HRef = "InvestigationForm.aspx?IID=" + Cryptography.Encrypt(DataBinder.Eval(e.Row.DataItem, "Id").ToString(), "sblw-3hn8-sqoy19");
        ...
        #endregion
        #region Methods
        protected void BindGridview(string refNumber, string incidentStatus, string isAnyPersonInjured, string isTreatmentProvided, string fromDate, string toDate, int personID)
        {
            try
            {
