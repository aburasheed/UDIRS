<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Form.Master" AutoEventWireup="true" CodeBehind="IMO_Form.aspx.cs" Inherits="UDIRS.Web.Admin.IMO_Form" %>
                ...
                <div class="divTableRow">
                    <div style="width: 1278px; margin-bottom: 0px; height: 46px; background-color: #293955;
                       ...
                       <%-- <asp:Button ID="btnSave" Text="Save" class="control-Btncontainer incident-count-btn"
                        ...
                        <asp:Button ID="btnGoBack" Text="Go Back" runat="server" Style="margin-left: 2px;  background-image: url(/Master/Images/go-back.png); background-repeat: no-repeat;
                            height: 35px;" Width="10%" Font-Overline="False" />
                        <%--<asp:Button ID="btnSaveSubmit" Text="Save and Send to RMO" class="control-Btncontainer incident-count-btn"
                            ValidationGroup="Form" runat="server" ><img src="~/Master/go-back.png" alt="Back"/></asp:Button>--%>
                    </div>
                </div>
            </div>
        </div>
