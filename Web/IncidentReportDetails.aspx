<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Form.Master" AutoEventWireup="true" CodeBehind="IncidentReportDetails.aspx.cs" Inherits="UDIRS.Web.IncidentReportDetails" %>
                ...
                <div class="divTableRow">
                    ...
                    <div class="divTable2ColumRMO">
                        <asp:Label ID="lblStatus" Style="padding-left: 5px; font-family: Lucida Bright, Georgia, serif;
                            font-size: 18px; font-style: italic; font-variant: normal;" runat="server" Text="Progress" />
                    </div>
                </div>
            </div>
